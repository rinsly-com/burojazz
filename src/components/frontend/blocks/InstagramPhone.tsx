...
/**
 * The hand-held phone in the social collage. Always renders the static phone
 * mockup (`phoneSrc`); when `live` is on and the worker returns a post, it
 * overlays that post's image on the phone screen and links to it. Any
