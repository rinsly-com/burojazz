...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_pages\`("id", "title", "generate_slug", "slug", "workflow_status", "updated_at", "created_at", "_status") SELECT "id", "title", "generate_slug", "slug", "workflow_status", "updated_at", "created_at", "_status" FROM \`pages\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__pages_v\`("id", "parent_id", "version_title", "version_generate_slug", "version_slug", "version_workflow_status", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest") SELECT "id", "parent_id", "version_title", "version_generate_slug", "version_slug", "version_workflow_status", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest" FROM \`_pages_v\`;`)
