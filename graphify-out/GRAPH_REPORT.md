# Graph Report - burojazz  (2026-07-18)

## Corpus Check
- 152 files · ~693,904 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1714 nodes · 2282 edges · 67 communities (60 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b6c26c7a`
...
Cohesion: 0.06
Nodes (53): Image(), robots(), sitemap(), Headers, JsonLd(), metadata, monaSans, montserrat (+45 more)

### Community 2 - "Admin UI Components"
Cohesion: 0.05
Nodes (49): AanmeldenDialog(), AanmeldenForm(), DsmValue, SiblingType, SubmitState, BackButton(), CheckboxField(), Field() (+41 more)
...
Cohesion: 0.14
Nodes (25): aboutBlock, accordionBlock, buttonRowBlock, complaintsBlock, contactPersonsBlock, coreValuesBlock, heroBlock, richTextBlock (+17 more)

### Community 5 - "Editorial Workflow & Roles"
Cohesion: 0.07
Nodes (20): importMap, Comment, CommentsPanel(), Ref, DeployNavLink(), IconModule, IconSelector(), SUGGESTED (+12 more)

### Community 6 - "E2E Auth & Fixtures"
Cohesion: 0.12
Nodes (25): CardData, DEFAULT_CARDS, DEFAULT_TABS, Props, ServiceCard(), Services(), CardData, ServiceCard() (+17 more)

### Community 7 - "Payload REST Catch-all Route"
Cohesion: 0.12
Nodes (19): metadata, About(), Props, Accordion(), Props, ALIGN, ButtonRow(), Props (+11 more)

### Community 8 - "Static Deploy Architecture"
Cohesion: 0.08
Nodes (14): Media, Pages, GET, OPTIONS, POST, adminOrigins, cloudflareLogger, corsOrigins (+6 more)
...
Cohesion: 0.22
Nodes (15): Hero(), Props, uploadUrl(), Photos, CAN_TRANSFORM, cfImageSrc(), cfImageSrcSet(), ImageTransform (+7 more)
...
Cohesion: 0.19
Nodes (11): adminFieldOnly(), adminOnly(), authenticated(), hasRole(), isAdmin(), isAuthenticated(), Role, Comments (+3 more)
...
Cohesion: 0.25
Nodes (10): isReviewer(), reviewerOnly(), pageBlocks, canPublishPages(), LABELS, ReviewPanel(), WorkflowAction(), enforceWorkflow() (+2 more)
...
Cohesion: 0.24
Nodes (9): DeployPanel(), PanelState, DeployView(), deployHandler(), DeployResult, triggerDeploy(), triggerStaticDeployAfterChange(), triggerStaticDeployAfterDelete() (+1 more)
...
## Knowledge Gaps
- **1200 isolated node(s):** `config`, `__BaseEnv_CloudflareEnv`, `Env`, `CloudflareEnv`, `StringifyValues` (+1195 more)
