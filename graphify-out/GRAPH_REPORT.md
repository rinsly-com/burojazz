...
## Corpus Check
- 154 files · ~693,381 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1723 nodes · 2292 edges · 68 communities (61 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `189d745b`
...
Cohesion: 0.05
Nodes (55): Image(), robots(), sitemap(), Headers, JsonLd(), metadata, monaSans, montserrat (+47 more)
...
Cohesion: 0.1
Nodes (25): About(), Props, Accordion(), Props, ALIGN, ButtonRow(), Props, Props (+17 more)
...
Cohesion: 0.2
Nodes (16): Hero(), Props, uploadUrl(), Props, Photos, SocialParallax(), CAN_TRANSFORM, cfImageSrc() (+8 more)
...
## Knowledge Gaps
- **1204 isolated node(s):** `config`, `__BaseEnv_CloudflareEnv`, `Env`, `CloudflareEnv`, `StringifyValues` (+1199 more)
