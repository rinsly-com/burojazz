...
## Corpus Check
- 153 files · ~693,031 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1717 nodes · 2286 edges · 73 communities (66 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6fba0031`
...
Cohesion: 0.05
Nodes (49): AanmeldenForm(), DsmValue, SiblingType, SubmitState, BackButton(), CheckboxField(), Field(), InputProps (+41 more)
...
Cohesion: 0.08
Nodes (15): Media, GET, OPTIONS, POST, adminOrigins, cloudflareLogger, corsOrigins, dirname (+7 more)

### Community 5 - "Editorial Workflow & Roles"
Cohesion: 0.1
Nodes (16): Comment, CommentsPanel(), Ref, DeployNavLink(), IconModule, IconSelector(), SUGGESTED, MediaCropper() (+8 more)

### Community 6 - "E2E Auth & Fixtures"
Cohesion: 0.14
Nodes (20): CardData, DEFAULT_CARDS, DEFAULT_TABS, Props, ServiceCard(), Services(), CardData, ServiceCard() (+12 more)
...
Cohesion: 0.13
Nodes (13): AanmeldenDialog(), robots(), sitemap(), metadata, monaSans, montserrat, structuredData, viewport (+5 more)

### Community 9 - "Static Build Script"
Cohesion: 0.15
Nodes (19): ContactPersons(), DEFAULT_PEOPLE, OBJECT_POSITION, PersonCard(), PHOTOS, Props, Hero(), Props (+11 more)
...
Cohesion: 0.18
Nodes (17): JsonLd(), generateMetadata(), HomePage(), PageView(), RenderBlocks(), buildPageMetadata(), PageMeta, PageWithMeta (+9 more)

### Community 13 - "Static Export Mode"
Cohesion: 0.16
Nodes (15): About(), Props, Accordion(), Props, ALIGN, ButtonRow(), Props, Props (+7 more)

### Community 14 - "Frontend Root Layout"
Cohesion: 0.21
Nodes (12): Headers, RootLayout(), apiOrigin(), readSnapshot(), fetchGlobal(), getFooter(), getHeader(), apiOrigin() (+4 more)
...
Cohesion: 0.15
Nodes (11): CARD_IMAGES, FALLBACK_CARDS, Props, Vacancies(), DEFAULT_ITEM_ICONS, DEFAULT_ITEMS, Props, VisionMission() (+3 more)
...
Cohesion: 0.19
Nodes (10): Props, Social(), Photos, SocialParallax(), Icon(), IconProps, icons, resolve() (+2 more)
...
Cohesion: 0.49
Nodes (6): Image(), Image(), metaImageUrl(), OG_SIZE, renderOgImage(), Image()

### Community 29 - "Community 29"
Cohesion: 0.22
Nodes (6): FALLBACK_INFO, FALLBACK_MENU, LinkItem, Props, SiteFooter(), SOCIALS
...
## Knowledge Gaps
- **1201 isolated node(s):** `config`, `__BaseEnv_CloudflareEnv`, `Env`, `CloudflareEnv`, `StringifyValues` (+1196 more)
...
- **Why does `Headers` connect `Frontend Root Layout` to `Access Control & Collections`?**
...
- **Should `API Routes & Cloudflare Runtime` be split into smaller, more focused modules?**
